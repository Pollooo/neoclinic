      ...
      <div class="footer-container">
        <div class="footer-grid">
          <div class="footer-section">
            <h3 class="footer-title">NeoClinic</h3>
            <p class="footer-description">
              {{ translationService.currentLanguage() === 'uz' 
                ? 'Zamonaviy tibbiy xizmatlar va professional shifokorlar' 
                : 'Современные медицинские услуги и профессиональные врачи' }}
            </p>
          ...
          <div class="footer-section">
            ...
            <ul class="footer-links">
              <li><a routerLink="/services">{{ translationService.t('common.services') }}</a></li>
              <li><a routerLink="/doctors">{{ translationService.t('common.doctors') }}</a></li>
              <li><a routerLink="/gallery">{{ translationService.t('common.gallery') }}</a></li>
            </ul>
          </div>
        ...
        <div class="footer-bottom">
          <p>&copy; {{ currentYear }} NeoClinic. {{ translationService.currentLanguage() === 'uz' ? 'Barcha huquqlar himoyalangan' : 'Все права защищены' }}.</p>
        </div>
      </div>
    </footer>
  `,
